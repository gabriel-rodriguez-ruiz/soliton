...
import scipy
from hamiltonians import Hamiltonian_A1u_semi_infinite, Hamiltonian_A1us_k, Hamiltonian_A1us_S_junction_k, Hamiltonian_S
...
spectrum_A1u = spectrum(Hamiltonian_S, k, t=t, mu=mu, L_x=L_x, Delta=Delta_0)
...
for mu_value in mu:
    ...
    spectrum_mu.append(spectrum(Hamiltonian_S, k, t=t, mu=mu_value, L_x=L_x, Delta=Delta_0))
    # phi = 0.2*np.pi
    # spectrum_mu.append(spectrum(Hamiltonian_A1us_S_junction_k, k, t=t, mu=mu_value, L_A1u=L_x//2, L_S=L_x//2, Delta_A1u=Delta, Delta_S=Delta_0, phi=phi, t_J=t_J))
